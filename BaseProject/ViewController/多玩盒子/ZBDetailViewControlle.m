...
@optional
-(void)EquipDetailCell:(EquipDetailCell *)cell completeWithEquipIdl:(NSInteger)equipId;
@end
    ...
    if (count>0) {
        ...
        for (int i = 0; i<count; i++) {
            ...
            [button bk_addEventHandler:^(id sender) {
                if ([self.delegate respondsToSelector:@selector(EquipDetailCell:completeWithEquipIdl:)]) {
                    [self.delegate EquipDetailCell:self completeWithEquipIdl:equipId];
                }
...
@interface ZBDetailViewControlle ()<UITableViewDelegate,UITableViewDataSource,EquipDetailCellDelegate>
@property(nonatomic,strong)ZBDetailViewModel *zbDetailVM;
@property(nonatomic,strong)UITableView *tableView;

@end

@implementation ZBDetailViewControlle
...
-(void)EquipDetailCell:(EquipDetailCell *)cell completeWithEquipIdl:(NSInteger)equipId{
    ZBDetailViewControlle *vc = [[ZBDetailViewControlle alloc]initWithEquipId:equipId];
